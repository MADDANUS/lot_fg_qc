...
// ── Master Data (Shift, Line, Mold, Cavity) — Admin only ────────────────────
...
$routes->post('users/create', 'UserManager::create');
$routes->post('users/update', 'UserManager::update');
